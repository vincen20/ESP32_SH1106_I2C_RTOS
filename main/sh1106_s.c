...
void sh1106_init(i2c_port_t i2c_num){
	...
	i2c_cmd(i2c_num,0xA7);// Disable Inverse Display On (0xa6/a7) 
...
esp_err_t i2c_testx(i2c_port_t i2c_num){
	...
	oled_cls(I2C_MASTER_NUM);
      oled_setxy(I2C_MASTER_NUM,0,0);
	i2c_data(I2C_MASTER_NUM,0x76);/*11100110*/
	i2c_data(I2C_MASTER_NUM,0x98);	/*10010001*/
	i2c_data(I2C_MASTER_NUM,0x98);/*10010001*/
	i2c_data(I2C_MASTER_NUM,0x98);/*10010001*/
	i2c_data(I2C_MASTER_NUM,0x27);/*01001110*/
